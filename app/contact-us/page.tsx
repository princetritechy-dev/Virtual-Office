  ...
  return (
    <main className="contact-page">
            ...
            <div className="contact-left">
              ...
              <div className="info-item">
                ...
                <div className="info-con">
                  ...
                  <br />
                 <div className="email"> info@virtualofficeanywhere.co.uk</div>
                </div>
              </div>
            </div>
      ...
      <section className="map-section">
        <iframe
          src="https://maps.google.com/maps?q=45%20Albemarle%20St,%20London%20W1S%204JL&t=&z=15&ie=UTF8&iwloc=&output=embed"
          loading="lazy"
          allowFullScreen
